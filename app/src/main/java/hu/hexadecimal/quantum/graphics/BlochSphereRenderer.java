...
public class BlochSphereRenderer implements Renderer {

    // Ambient light
    private final float[] mat_ambient = { 2.4f, 2.4f, 0.8f, 1f };
    private FloatBuffer mat_ambient_buf;
    // Parallel incident light
    private final float[] mat_diffuse = { 0.3f, 0.3f, 0.2f, 0.5f };
    private FloatBuffer mat_diffuse_buf;
    // The highlighted area
    private final float[] mat_specular = { 0.2f * 0.3f, 0.2f * 0.3f, 0.2f * 0.2f, 0.5f };
